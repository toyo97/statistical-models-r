...
`phyper` and `pbinom`. We can do this for several values of $x_0$ i.e.
...
i.e. the roulette favors the red or the roulette favors the black *in the
...
> have to consider *all* cases that happen with a lower or equal
