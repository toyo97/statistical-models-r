...
\begin{verbatim}
##  [1]   3.481589 -14.993989  -0.263854 -10.533974  -9.974914  -4.220047
##  [7]   9.341907   8.410405  -5.788265   5.764697
\end{verbatim}
...
\begin{verbatim}
##  [1]  1.1786512  0.5189134 -1.0445893 -2.8316918  0.1804755 -0.4073548
##  [7]  1.0915080 -2.1503819 -0.6723944  0.6825851
\end{verbatim}
...
\begin{verbatim}
##  [1] 2.847210e-01 1.332208e-01 3.873098e-03 3.400591e-06 7.620919e-02
##  [6] 2.200211e-02 2.640498e-01 7.251092e-05 1.122306e-02 1.675071e-01
\end{verbatim}
...
\begin{verbatim}
##  [1] 0.880731460 0.698089442 0.148106411 0.002315123 0.571610364 0.341873709
##  [7] 0.862475294 0.015762510 0.250666311 0.752565484
\end{verbatim}
...
\begin{verbatim}
##            a         b
## 1 -0.4801796 0.2305724
## 2  0.9055271 0.8199793
\end{verbatim}
...
We want to study the effect on the response (variable \emph{distance})
of 4 different brands of golf ball (A,B,C,D) (variable \emph{brand})
and the club type (DRIVER/IRON) (variable \emph{club}).
These two features are qualitative predictors, also called factors.
A robot player is used.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wide\_golf }\OtherTok{\textless{}{-}} \FunctionTok{read\_tsv}\NormalTok{(}\StringTok{"./datasets/golfer.tsv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
This can be done with \texttt{read\_tsv}, first by reading the data as it is
...
setting the \texttt{read\_tsv} parameter \texttt{col\_types} to that.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wide\_golf }\OtherTok{\textless{}{-}} \FunctionTok{read\_tsv}\NormalTok{(}\StringTok{"./datasets/golfer.tsv"}\NormalTok{,}
  \AttributeTok{col\_types =} \FunctionTok{cols}\NormalTok{(}
    \AttributeTok{club =}\NormalTok{ readr}\SpecialCharTok{::}\FunctionTok{col\_factor}\NormalTok{(),}
...
\NormalTok{golf }\OtherTok{\textless{}{-}}\NormalTok{ wide\_golf }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{gather}\NormalTok{(brand, distance, A}\SpecialCharTok{:}\NormalTok{D)}
...
Let us study first the effect of \emph{brand} on the \emph{distance}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm\_brand }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(distance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ brand, }\AttributeTok{data =}\NormalTok{ golf)}
\FunctionTok{summary}\NormalTok{(lm\_brand)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{model.matrix}\NormalTok{(lm\_brand) }\CommentTok{\# this is the design matrix}
\end{Highlighting}
\end{Shaded}
...
be produced using \emph{ggplot2}.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{boxplot}\NormalTok{(distance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ brand, }\AttributeTok{data =}\NormalTok{ golf)}
\end{Highlighting}
\end{Shaded}

\includegraphics{smr_book_files/figure-latex/unnamed-chunk-153-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{golf}\SpecialCharTok{$}\NormalTok{brand }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(golf}\SpecialCharTok{$}\NormalTok{brand)}
\FunctionTok{plot.design}\NormalTok{(distance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ brand, }\AttributeTok{data =}\NormalTok{ golf)}
\end{Highlighting}
\end{Shaded}

\includegraphics{smr_book_files/figure-latex/unnamed-chunk-153-2.pdf}
...
Back to our dataset, let us now add the second factor \emph{club} and build a `small'
additive model\ldots{}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{small\_lm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(distance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ brand }\SpecialCharTok{+}\NormalTok{ club, }\AttributeTok{data =}\NormalTok{ golf)}
\FunctionTok{summary}\NormalTok{(small\_lm)}
\end{Highlighting}
\end{Shaded}
...
\ldots{} and a larger one with interaction.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{large\_lm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(distance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ brand }\SpecialCharTok{*}\NormalTok{ club, }\AttributeTok{data =}\NormalTok{ golf)}
\FunctionTok{summary}\NormalTok{(large\_lm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot.design}\NormalTok{(distance }\SpecialCharTok{\textasciitilde{}}\NormalTok{ brand }\SpecialCharTok{*}\NormalTok{ club, }\AttributeTok{data =}\NormalTok{ golf)}
\end{Highlighting}
\end{Shaded}

\includegraphics{smr_book_files/figure-latex/unnamed-chunk-156-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{interaction.plot}\NormalTok{(golf}\SpecialCharTok{$}\NormalTok{brand, golf}\SpecialCharTok{$}\NormalTok{club, golf}\SpecialCharTok{$}\NormalTok{distance)}
\end{Highlighting}
\end{Shaded}

\includegraphics{smr_book_files/figure-latex/unnamed-chunk-156-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{anova}\NormalTok{(large\_lm)}
\end{Highlighting}
\end{Shaded}
...
With the last \emph{anova()} command we have built a more
traditional anova table.
We can compare the two models also with the \emph{anova} command.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{anova}\NormalTok{(small\_lm, large\_lm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{fitted}\NormalTok{(large\_lm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{predict.lm}\NormalTok{(small\_lm,}
  \AttributeTok{newdata =} \FunctionTok{data.frame}\NormalTok{(}
    \AttributeTok{club =} \FunctionTok{c}\NormalTok{(}\StringTok{"DRIVER"}\NormalTok{, }\StringTok{"IRON"}\NormalTok{, }\StringTok{"IRON"}\NormalTok{),}
    \AttributeTok{brand =} \FunctionTok{c}\NormalTok{(}\StringTok{"A"}\NormalTok{, }\StringTok{"B"}\NormalTok{, }\StringTok{"B"}\NormalTok{)}
\NormalTok{  ),}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# for prediction intervals...}
\FunctionTok{predict.lm}\NormalTok{(large\_lm,}
  \AttributeTok{newdata =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{club =} \StringTok{"DRIVER"}\NormalTok{, }\AttributeTok{brand =} \StringTok{"A"}\NormalTok{),}
  \AttributeTok{interval =} \StringTok{"prediction"}\NormalTok{,}
  \AttributeTok{level =}\NormalTok{ .}\DecValTok{99}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-170-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-171-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-173-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-188-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-189-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-190-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-200-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-215-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-217-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-226-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-227-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-228-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-229-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-230-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-238-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-239-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-240-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-251-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-253-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-255-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-262-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-263-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-282-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-297-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-301-1.pdf}
...
\includegraphics{smr_book_files/figure-latex/unnamed-chunk-303-1.pdf}
